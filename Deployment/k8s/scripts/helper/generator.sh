...
generate_root_ca() {
  ...
  local ca_dir="$certs_dir/${2:-ca}"  # default folder name is "ca"
...
generate_tls_certs() {
  ...
  generate_cert_with_keystore_and_truststore "keycloak" "keycloak.cluster-0-kafka.test" "keycloak-service.keycloak.svc.cluster.local"
}
