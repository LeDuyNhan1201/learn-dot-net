...
create_env_file() {
  ...
  local vars=(
    ...
    APP_IDP_URL
    APP_IDP_REALM
    APP_IDP_TOKEN_ENDPOINT
    APP_IDP_JWKS_ENDPOINT
    APP_IDP_EXPECTED_ISSUER
    APP_IDP_AUTH_ENDPOINT
    APP_IDP_AUTH_DEVICE_ENDPOINT
    APP_IDP_SUB_CLAIM_NAME
    APP_IDP_SCOPE_CLAIM_NAME
    APP_IDP_GROUP_CLAIM_NAME
    APP_IDP_EXPECTED_AUDIENCE
